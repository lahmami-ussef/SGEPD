...
import { Tv, AlertCircle, Building2, Activity } from 'lucide-react';
  ...
  <Layout>
    ...
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '20px' }}>
      <div>
        ...
        <p style={{ fontSize: '12px', color: '#94a3b8', margin: 0 }}>Lundi 11 mai 2026</p>
      </div>
      <div style={{ display: 'flex', gap: '8px' }}>
        <button style={{ fontSize: '12px', color: '#64748b', border: '1px solid #e2e8f0', background: '#fff', padding: '6px 12px', borderRadius: '8px', cursor: 'pointer' }}>
          🔔 3
        </button>
        <button style={{ fontSize: '12px', color: '#64748b', border: '1px solid #e2e8f0', background: '#fff', padding: '6px 12px', borderRadius: '8px', cursor: 'pointer' }}>
          ↺ Actualiser
    ...
    <div style={{ display: 'grid', gridTemplateColumns: '1.6fr 1fr', gap: '12px', marginBottom: '14px' }}>
      ...
      {/* Statuts */}
      <div style={cardBase}>
        <CardHeader title="Statut des écrans" subtitle="Vue globale — 173 écrans" />
